...
const Pizza = (props) => {
  // props allows the component to set properties when it is called
...
// class == component
const App = () => {
  // this is called a react component, it is a function that returns a React element
  return React.createElement(
    // this is the element returned
    ...
    [
      ...
      React.createElement(Pizza, {
        ...
        ingredients: "Parmesan, Mozzarella, Ricotta, Gorgonazola",
      }),
      React.createElement(Pizza, {
      ...
      React.createElement(Pizza, {
        ...
        ingredients: "Bell Peppers, Onions, Mushrooms, Black Olives",
      }),
      React.createElement(Pizza, {
        name: "Hawaiian Pizza",
...
const root = createRoot(container); // Create a React root using the root element
